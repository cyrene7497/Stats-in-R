...
```{r}
ggplot(data = nc_fullterm, aes(x = weight)) +geom_histogram(binwidth = 1)
...
bayes_inference(y = weight, data = nc_fullterm, statistic = "mean", type = "ci", cred_level = 0.95, prior_family = "JZS", mu_0 = 7.7, rscale = 1, method = "simulation") 
...
bayes_inference(y = weight, data = nc_fullterm, statistic = "mean", type = "ht", cred_level = 0.95, alternative = "twosided", show_plot=FALSE, hypothesis_prior = c(H1 = 7.7, H2 != 7.7), n_0 = 1) 
#prior_family = "JZS", mu_0 = 7.7, rscale = 1, method = "simulation")
```
